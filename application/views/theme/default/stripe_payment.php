...
<html lang="en">
    ...
    <body>        
        <form method="post" action="<?php echo base_url('subscription/stripe/'.$plan_id.'/'.$video_id);?>">            
            <label>
        ...
        <?php $stripe_publishable_key = $this->db->get_where('config', array('title' => 'stripe_publishable_key'))->row()->value; ?>
        <script>
            var test_key="<?=$stripe_publishable_key?>";
