        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="sendus">
                    ...
                    <?php endif; ?>
                    <?php $checked1='checked';$checked2='';
                    if(isset($referrel_message) &&  $referrel_message !=''):
                        $checked1='';$checked2='checked';
                        ?>
                        <div class="alert alert-success">
                           <?php echo $referrel_message; ?>
                        </div>
                    <?php endif; ?>
                    <?php if(isset($referrel_message_error) && $referrel_message_error !=''):?>
                        <div class="alert alert-danger">
                           <?php echo $referrel_message_error; ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <div id="contact-form">
                        ...
                        <form class="custom-form" id="signup-form" method="post" action="<?php echo base_url().'user/signup/do_signup'; ?>">
                            <?php if($recaptcha_enable == '1'): echo $this->recaptcha->create_box(); endif;?>
                            <input type="hidden" value="<?=$ref_code?>" name="ref_code">
                            ...
                            Account Type: <input type="radio" name="account_type" <?=$checked1?>  value="1">User&nbsp; &nbsp;<input type="radio" name="account_type" <?=$checked2?> value="2"> Publisher
