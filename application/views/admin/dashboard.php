   <?php
   $video_where=array('publication' => '1', 'is_tvseries' => '0');
   $series_where=array('publication' => '1', 'is_tvseries' => '1');
 if($this->session->userdata('publisher_is_login') == 1){
     $video_where['created_by']=$this->session->userdata('user_id');
     $series_where['created_by']=$this->session->userdata('user_id');
 }
?>
<div class="row">
  <div class="col-md-3">
    <div class="widget-small primary"><i class="icon fa fa-video-camera fa-3x"></i>
      <div class="info">
        ...
        <p><b class="counter"><?php echo $this->db->get_where('videos', $video_where)->num_rows(); ?></b></p>
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="widget-small info"><i class="icon fa fa-video-camera fa-3x"></i>
      <div class="info">
        ...
        <p><b class="counter"><?php echo $this->db->get_where('videos', $series_where)->num_rows(); ?></b></p>
      </div>
    </div>
  </div>
    <?php
