      ...
      <div class="col-md-6">
        <div class="panel panel-border panel-primary">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <label class="col-sm-6 control-label"><?php echo trans('My Refferal person code'); ?></label>
              <div class="col-sm-6">
                <input type="text" value="<?php echo $row['invited_by_ref_code']; ?>" name="invited_by_ref_code" class="form-control"  placeholder="<?php echo trans('enter_invited_ref_code'); ?>" />
              </div>
            </div>
