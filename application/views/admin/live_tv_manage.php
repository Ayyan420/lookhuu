    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a href="<?php echo base_url() . 'admin/manage_live_tv/new'; ?>" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span><?php echo trans('add_live_tv'); ?></a> <br>
