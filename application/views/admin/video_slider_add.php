...
<?php echo form_open(base_url() . 'admin/video_slider/add/' , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>

<h4 class="text-center">New Video slider Add</h4>
<hr>
...
<div class="form-group">
  <label class="control-label col-sm-12">Video</label>
  <div class="col-sm-12" >
      <div class="profile-info-name text-center"> <video id="thumb_image"  controls=""  src="<?php echo base_url('uploads/default_image/slide.jpg'); ?>" class="img-thumbnail" alt="" ></video> </div>
    <br>
