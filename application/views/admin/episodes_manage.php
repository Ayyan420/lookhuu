          ...
          <div class="tab-pane active" id="tabs-1" role="tabpanel">
            <?php echo form_open_multipart(base_url('admin/episodes_upload')); ?>           
              ...
              <div class="form-group">
                <label class="control-label"><?php echo trans('episodes_name') ?></label>&nbsp;&nbsp;<input id="episodes_name" type="text" name="episodes_name" class="form-control" placeholder="Episode-1" value="Episode-" required="">
              </div>
              <div class="form-group">
                <label class="control-label"><?php echo trans('order'); ?></label>
                <input type="number" name="order" class="form-control" placeholder="0 to 9999" value="1" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="source" id="selected-source">
                  ...
                  <option value="embed" selected <?php if($video_source =='embed'): echo 'selected'; endif;?>><?php echo trans('embed_url');?></option>
                </select>
              </div>
              <div class="form-group" <?php if($video_source =='upload'): echo 'style="display:none;"'; endif;?> id="url-input">
                ...
                <input type="text" name="url" id="url-input-field" value="https://videoseyred.in/embed/" class="form-control" placeholder="http://server-2.com/movies/titalic.mp4" <?php if($video_source !='upload'): echo 'required'; endif;?> ><br>
              </div>
