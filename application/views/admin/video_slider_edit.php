...
<?php 
$sliders   = $this->db->get_where('video_slider' , array('slider_id' => $param2) )->result_array();
foreach ( $sliders as $row):
?>
<?php echo form_open(base_url() . 'admin/video_slider/update/'.$param2 , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>

<h4 class="text-center">Video Slider Edit</h4>
<hr>
...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <div class="profile-info-name text-center"> <video id="thumb_image" controls="" src="<?php echo $row['image_link'];?>" class="img-thumbnail" alt=""></video> </div>
        <br>
        <div id="thumbnail_content">
            <input type="file" id="thumbnail_file" onchange="showImg(this);" name="video" class="filestyle" data-input="false" accept="video/*"></div><br>
...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <select class="form-control m-bot15" name="action_type" id="action_type">
          ...
          <option value="disabled" <?php if($row['action_type']=='disabled'): echo "selected"; endif; ?>>Disabled</option>
        </select>
    </div>
</div>
...
<div id="url" <?php if($row['action_type'] !='external_browser' && $row['action_type'] !='webview' && $row['action_type'] =='disabled'): echo 'style="display: none;"'; endif; ?>>
  <div class="form-group">
...
<div class="form-group" id="actionbutton" <?php if($row['action_type'] =='disabled'): echo 'style="display: none;"'; endif; ?>>
