            ...
            <div class="card-block">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <select  class="form-control is_paid" onchange="show_fixed_price_input(this.value)"  name="is_paid">
                      <option value="0" selected>Free</option>
                      <option value="1">For website subscribers</option>
                      <option value="2">One time payment</option>
                      <option value="3">Monthly Subscription</option>
                    </select>
                </div>
                <input type="text" min="0.1" class="form-control fixed_price" name="fixed_price" style="display:none" placeholder="Enter the price">
                <br><br>
            <br><br>
            </div>
        </div>
